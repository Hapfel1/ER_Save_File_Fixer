...
class PlayerGameData:
    ...
    # Character name (0x94-0xB3) - UTF-16LE, 32 chars max
    character_name: str = ""
    terminator: int = 0
    ...
    # Passwords (0x110-0x17B) - UTF-16LE, 16 chars max each
    password: str = ""
    ...
    def read(cls, f: BytesIO) -> PlayerGameData:
        ...
        # Character name (UTF-16LE, 32 chars)
        ...
        # Passwords (UTF-16LE, 16 chars each)
